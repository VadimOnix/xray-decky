...
def validate_vless_url(url: str) -> tuple[bool, Optional[str]]:
    ...
    return False, "Invalid VLESS URL format. Expected vless://uuid@host:port?params#name or base64 subscription"


def build_vless_config(parsed: Dict[str, Any], source_url: str, config_type: str) -> Dict[str, Any]:
    """
    ...
    if config.get("security") == "reality":
        ...
        if "fp" in params or "fingerprint" in params:
            reality_config["fingerprint"] = params.get("fp") or params.get("fingerprint")
